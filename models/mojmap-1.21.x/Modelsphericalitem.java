...
public class Modelsphericalitem<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "sphericalitem"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition hexadecagon = partdefinition.addOrReplaceChild("hexadecagon",
				CubeListBuilder.create().texOffs(0, 1)
						.addBox(-2.0F, 6.0109F, -10.0F, 4.0F, 3.9782F, 9.8F, new CubeDeformation(0.0F)).texOffs(0, 1)
						.addBox(-2.0F, 6.0109F, 0.2F, 4.0F, 3.9782F, 9.8F, new CubeDeformation(0.0F)).texOffs(0, 1)
						.addBox(-2.0F, 8.2F, -1.9891F, 4.0F, 9.8F, 3.9782F, new CubeDeformation(0.0F)).texOffs(0, 1)
						.addBox(-2.0F, -2.0F, -1.9891F, 4.0F, 9.8F, 3.9782F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 16.0F, 0.0F));

		PartDefinition hexadecagon_r1 = hexadecagon.addOrReplaceChild("hexadecagon_r1",
				CubeListBuilder.create().texOffs(0, 1)
						.addBox(-2.0F, -10.0F, -1.9891F, 4.0F, 9.8F, 3.9782F, new CubeDeformation(0.0F)).texOffs(0, 1)
						.addBox(-2.0F, 0.2F, -1.9891F, 4.0F, 9.8F, 3.9782F, new CubeDeformation(0.0F)).texOffs(0, 1)
						.addBox(-2.0F, -1.9891F, 0.2F, 4.0F, 3.9782F, 9.8F, new CubeDeformation(0.0F)).texOffs(0, 1)
						.addBox(-2.0F, -1.9891F, -10.0F, 4.0F, 3.9782F, 9.8F, new CubeDeformation(0.0F)),
