...
public class SkillKey6OnKeyPressedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (!world.isClientSide()) {
			if (entity.getPersistentData().getDouble("overheat") == 0) {
				entity.getPersistentData().putBoolean("fire", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).fire6);
				entity.getPersistentData().putBoolean("water", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).water6);
				entity.getPersistentData().putDouble("keypressed", 1);
				entity.getPersistentData().putDouble("magicpower", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicpower6);
				entity.getPersistentData().putDouble("magicspeed", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicspeed6);
				entity.getPersistentData().putDouble("magicsize", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicsize6);
				entity.getPersistentData().putDouble("overheat", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).overheat6);
				entity.getPersistentData().putDouble("magicstyle", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicstyle6);
				entity.getPersistentData().putDouble("piercing", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).Piercing6);
				entity.getPersistentData().putDouble("tracking", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).Tracking6);
				entity.getPersistentData().putDouble("magicshape", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).MagicShape6);
				entity.getPersistentData().putDouble("magicfollow", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).MagicFollowSetting6);
				entity.getPersistentData().putDouble("magicduration", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).MagicDuration6);
				entity.getPersistentData().putDouble("multicast", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).MultiCast6);
				entity.getPersistentData().putDouble("magicdirection", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicdirection6);
				entity.getPersistentData().putDouble("castingoffset", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).castingoffset6);
				entity.getPersistentData().putDouble("guidedmagic", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).guidedmagic6);
				entity.getPersistentData().putDouble("gravity", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).gravity6);
				entity.getPersistentData().putDouble("areacoverage", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).areacoverage6);
				entity.getPersistentData().putString("spellname", (entity.getDisplayName().getString() + "" + (": \"" + "" + (entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicname6 + "" + "\""))));
