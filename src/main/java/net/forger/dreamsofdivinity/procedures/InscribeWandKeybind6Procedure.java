...
public class InscribeWandKeybind6Procedure {
	public static void execute(Entity entity) {
		...
		MutableComponent spellcoloritem = Component.empty();
		{
			...
			final boolean _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).fire6;
		...
		}
		{
			...
			final boolean _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).water6;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putBoolean(_tagName, _tagValue));
		}
		{
		...
		}
		{
			...
			final String _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicname6;
		...
		}
		{
			...
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicpower6;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "magicspeed";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicspeed6;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "magicsize";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicsize6;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "overheat";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).overheat6;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "magicstyle";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicstyle6;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "piercing";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).Piercing6;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "tracking";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).Tracking6;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "magicshape";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).MagicShape6;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "magicfollow";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).MagicFollowSetting6;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "magicduration";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).MagicDuration6;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "multicast";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).MultiCast6;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "magicdirection";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicdirection6;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "castingoffset";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).castingoffset6;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "guidedmagic";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).guidedmagic6;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "areacoverage";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).areacoverage6;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
	}
}