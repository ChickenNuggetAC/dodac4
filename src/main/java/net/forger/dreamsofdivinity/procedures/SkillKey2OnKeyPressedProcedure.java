...
public class SkillKey2OnKeyPressedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (!world.isClientSide()) {
			if (entity.getPersistentData().getDouble("overheat") == 0) {
				entity.getPersistentData().putBoolean("fire", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).fire2);
				entity.getPersistentData().putBoolean("water", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).water2);
				entity.getPersistentData().putDouble("keypressed", 1);
				entity.getPersistentData().putDouble("magicpower", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicpower2);
				entity.getPersistentData().putDouble("magicspeed", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicspeed2);
				entity.getPersistentData().putDouble("magicsize", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicsize2);
				entity.getPersistentData().putDouble("overheat", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).overheat2);
				entity.getPersistentData().putDouble("magicstyle", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicstyle2);
				entity.getPersistentData().putDouble("piercing", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).Piercing2);
				entity.getPersistentData().putDouble("tracking", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).Tracking2);
				entity.getPersistentData().putDouble("magicshape", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).MagicShape2);
				entity.getPersistentData().putDouble("magicfollow", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).MagicFollowSetting2);
				entity.getPersistentData().putDouble("magicduration", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).MagicDuration2);
				entity.getPersistentData().putDouble("multicast", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).MultiCast2);
				entity.getPersistentData().putDouble("magicdirection", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicdirection2);
				entity.getPersistentData().putDouble("castingoffset", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).castingoffset2);
				entity.getPersistentData().putDouble("guidedmagic", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).guidedmagic2);
				entity.getPersistentData().putDouble("gravity", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).gravity2);
				entity.getPersistentData().putDouble("areacoverage", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).areacoverage2);
				entity.getPersistentData().putString("spellname", (entity.getDisplayName().getString() + "" + (": \"" + "" + (entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicname2 + "" + "\""))));
