...
public class SkillKey1OnKeyPressedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (!world.isClientSide()) {
			if (entity.getPersistentData().getDouble("overheat") == 0) {
				entity.getPersistentData().putBoolean("fire", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).fire1);
				entity.getPersistentData().putBoolean("water", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).water1);
				entity.getPersistentData().putDouble("keypressed", 1);
				entity.getPersistentData().putDouble("magicpower", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicpower1);
				entity.getPersistentData().putDouble("magicspeed", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicspeed1);
				entity.getPersistentData().putDouble("magicsize", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicsize1);
				entity.getPersistentData().putDouble("overheat", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).overheat1);
				entity.getPersistentData().putDouble("magicstyle", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicstyle1);
				entity.getPersistentData().putDouble("piercing", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).Piercing1);
				entity.getPersistentData().putDouble("tracking", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).Tracking1);
				entity.getPersistentData().putDouble("magicshape", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).MagicShape1);
				entity.getPersistentData().putDouble("magicfollow", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).MagicFollowSetting1);
				entity.getPersistentData().putDouble("magicduration", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).MagicDuration1);
				entity.getPersistentData().putDouble("multicast", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).MultiCast1);
				entity.getPersistentData().putDouble("magicdirection", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicdirection1);
				entity.getPersistentData().putDouble("castingoffset", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).castingoffset1);
				entity.getPersistentData().putDouble("guidedmagic", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).guidedmagic1);
				entity.getPersistentData().putDouble("gravity", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).gravity1);
				entity.getPersistentData().putDouble("areacoverage", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).areacoverage1);
				entity.getPersistentData().putString("spellname", (entity.getDisplayName().getString() + "" + (": \"" + "" + (entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicname1 + "" + "\""))));
