...
public class SkillKey3OnKeyPressedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (!world.isClientSide()) {
			if (entity.getPersistentData().getDouble("overheat") == 0) {
				entity.getPersistentData().putBoolean("fire", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).fire3);
				entity.getPersistentData().putBoolean("water", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).water3);
				entity.getPersistentData().putDouble("keypressed", 1);
				entity.getPersistentData().putDouble("magicpower", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicpower3);
				entity.getPersistentData().putDouble("magicspeed", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicspeed3);
				entity.getPersistentData().putDouble("magicsize", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicsize3);
				entity.getPersistentData().putDouble("overheat", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).overheat3);
				entity.getPersistentData().putDouble("magicstyle", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicstyle3);
				entity.getPersistentData().putDouble("piercing", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).Piercing3);
				entity.getPersistentData().putDouble("tracking", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).Tracking3);
				entity.getPersistentData().putDouble("magicshape", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).MagicShape3);
				entity.getPersistentData().putDouble("magicfollow", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).MagicFollowSetting3);
				entity.getPersistentData().putDouble("magicduration", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).MagicDuration3);
				entity.getPersistentData().putDouble("multicast", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).MultiCast3);
				entity.getPersistentData().putDouble("magicdirection", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicdirection3);
				entity.getPersistentData().putDouble("castingoffset", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).castingoffset3);
				entity.getPersistentData().putDouble("guidedmagic", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).guidedmagic3);
				entity.getPersistentData().putDouble("gravity", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).gravity3);
				entity.getPersistentData().putDouble("areacoverage", entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).areacoverage3);
				entity.getPersistentData().putString("spellname", (entity.getDisplayName().getString() + "" + (": \"" + "" + (entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicname3 + "" + "\""))));
