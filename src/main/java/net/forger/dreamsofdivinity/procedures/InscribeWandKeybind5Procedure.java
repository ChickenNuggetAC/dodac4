...
public class InscribeWandKeybind5Procedure {
	public static void execute(Entity entity) {
		...
		MutableComponent spellcoloritem = Component.empty();
		{
			...
			final boolean _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).fire5;
		...
		}
		{
			...
			final boolean _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).water5;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putBoolean(_tagName, _tagValue));
		}
		{
		...
		}
		{
			...
			final String _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicname5;
		...
		}
		{
			...
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicpower5;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "magicspeed";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicspeed5;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "magicsize";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicsize5;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "overheat";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).overheat5;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "magicstyle";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicstyle5;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "piercing";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).Piercing5;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "tracking";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).Tracking5;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "magicshape";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).MagicShape5;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "magicfollow";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).MagicFollowSetting5;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "magicduration";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).MagicDuration5;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "multicast";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).MultiCast5;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "magicdirection";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicdirection5;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "castingoffset";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).castingoffset5;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "guidedmagic";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).guidedmagic5;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "areacoverage";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).areacoverage5;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
	}
}