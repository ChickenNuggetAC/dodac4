...
public class InscribeWandKeybind4Procedure {
	public static void execute(Entity entity) {
		...
		MutableComponent spellcoloritem = Component.empty();
		{
			...
			final boolean _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).fire4;
		...
		}
		{
			...
			final boolean _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).water4;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putBoolean(_tagName, _tagValue));
		}
		{
		...
		}
		{
			...
			final String _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicname4;
		...
		}
		{
			...
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicpower4;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "magicspeed";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicspeed4;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "magicsize";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicsize4;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "overheat";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).overheat4;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "magicstyle";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicstyle4;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "piercing";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).Piercing4;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "tracking";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).Tracking4;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "magicshape";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).MagicShape4;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "magicfollow";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).MagicFollowSetting4;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "magicduration";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).MagicDuration4;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "multicast";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).MultiCast4;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "magicdirection";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).magicdirection4;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "castingoffset";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).castingoffset4;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "guidedmagic";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).guidedmagic4;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
		{
			final String _tagName = "areacoverage";
			final double _tagValue = entity.getData(DreamsOfDivinityModVariables.PLAYER_VARIABLES).areacoverage4;
			CustomData.update(DataComponents.CUSTOM_DATA, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY), tag -> tag.putDouble(_tagName, _tagValue));
		}
	}
}